...
<?= $this->section('content') ?>
    ...
    <section
      class="w-full min-h-screen mx-auto px-5 mt-12 py-8 sm:px-20 sm:py-10 sm:mt-14">
      <!-- News -->
            ...
            <div class="py-8 lg:pe-8">
              <div class="space-y-5 lg:space-y-8">
                ...
                <div class="text-center">
                  <figure>
                    <img class="w-full object-cover rounded-xl" src="<?= base_url('images-thumbnail/' . $news['thumbnail']) ?>" alt="Image Description">
            ...
            <div class="sticky top-0 start-0 py-8 lg:ps-8">
              ...
              <div class="space-y-6">
                ...
                <a class="group flex items-center gap-x-6" href="#">
                  ...
                  <div
                    class="flex-shrink-0 relative rounded-lg overflow-hidden size-20"
                  >
                    <img
