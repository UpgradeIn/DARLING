<!-- ========== FOOTER ========== -->
<footer class="mt-auto w-full bg-[#E8E8E8] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <!-- Grid -->
  <div class="text-center">
    <div class="flex justify-center">
      <img src="<?php echo base_url('assets/images/damri.png'); ?>" alt="Card Image" style="max-width: 120px; max-height: 120px;">
    </div>
    <!-- End Col -->

    <div class="mt-3">
      <p class="text-blue-900 dark:text-neutral-500">Damri Academy for Reliable Learning and Innovation Guidance</p>
      <p class="text-black dark:text-neutral-500">© Damri All rights reserved.</p>
    </div>
