    ...
    <section class="w-full mx-auto py-5 px-10 sm:py-10 lg:px-20 lg:h-screen">
        <div class="flex h-full gap-10 justify-center md:justify-between lg:grow">
            ...
            <div class="mx-auto w-full pt-6 md:pe-0 md:w-2/3 lg:pe-0 xl:w-5/12">
                <div class="mb-4 text-left lg:text-right">
                    <span>Sudah memiliki akun? </span>
                    <a href="<?= base_url('auth/login')?>" class="text-blue-600 hover:underline">Masuk sekarang</a>
                </div>
                <div class="space-y-5 sm:space-y-5">
                    <div class="space-y-2">
                        ...
                        <p class="text-base text-gray-500 dark:text-neutral-500">
                            Silahkan Form Berikut untuk Mendaftar.
                        </p>
                    </div>
                        ...
                        <div class="space-y-3 pt-2">
                            <div class="space-y-2">
                                <div id="form_input">
                                    ...
                                    <div class="py-2 text-sm text-red-400">
