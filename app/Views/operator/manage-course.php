                                                    ...
                                                    <div class="sm:divide-y divide-gray-200 dark:divide-neutral-700">
                                                        <div class="py-3 sm:py-6">
                                                            ...
                                                            <div class="w-full px-4 sm:px-6 lg:px-8 mx-auto">
                                                                ...
                                                                <div class="py-5">
                                                                    <!-- Form -->
                                                                    <form action="<?= base_url('create-courses'); ?>" method="POST" enctype="multipart/form-data">
                                                                        <?= csrf_field(); ?>
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                        ...
                                        <tr>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span class="text-sm text-gray-600 dark:text-neutral-400"><?= $no++ ?>.</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span class="text-sm text-gray-600 dark:text-neutral-400"><?= $course['name'] ?></span>
                                                </div>
                                            </td>
                                            <!-- <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3 text-start">
                                                    <span class="text-sm text-gray-600 dark:text-neutral-400"><?= $course['published_at'] ? $course['published_at'] : 'Belum dipublikasi' ?></span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3 text-center">
                                                    <span class="text-sm text-gray-600 dark:text-neutral-400"><?= $course['status'] ?></span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5 text-end">
                                                    <div class="hs-dropdown [--placement:bottom-right] relative inline-block">
                                                        <a href="<?= base_url('detail-course/').$course['slug'] ?>" type="button" class="block" data-hs-overlay="#hs-ai-invoice-modal">
                                        ...
                                        <tr>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span class="text-sm text-gray-600 dark:text-neutral-400">3599</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
