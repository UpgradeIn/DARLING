    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 lg:gap-7">
      <div class="lg:col-span-3">
        <div class="aspect-w-10 aspect-h-10 lg:aspect-none">
          <img class="w-full h-auto object-cover shadow-md rounded-xl" src="<?= base_url('images-thumbnail/') . $learningPaths['thumbnail'] ?>" alt="Thumbnail Learning Path" />
        </div>
      </div>
          ...
          <div class="space-y-3">
            <div class="flex justify-between">
              ...
              <?php if ($learningPaths['status'] != 'publish') : ?>
                  ...
                  <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                    <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
                      <div class="absolute top-2 end-2">
                        <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-transparent dark:hover:bg-neutral-700" data-hs-overlay="#hs-publish-learning-path">
                      ...
                      <div class="p-4 sm:p-10 text-center overflow-y-auto">
                        <!-- Icon -->
                         <!-- Icon -->
                         <span class="mb-4 inline-flex justify-center items-center size-[62px] rounded-full border-4 <?php if ($learningPaths['status'] == 'publish') : ?>border-gray-50 bg-gray-100 text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100<?php else : ?>border-green-50 bg-green-100 text-green-500 dark:bg-green-700 dark:border-green-600 dark:text-green-100<?php endif; ?>">
                          <?php if ($learningPaths['status'] == 'publish') : ?>
                        ...
                        <p class="text-gray-500 dark:text-neutral-500">
                          Apakah Anda yakin ingin melakakukan publikasi pada learning path ini?
                        </p>

                        <div class="mt-6 flex justify-center gap-x-4">
                          <?php if ($learningPaths['status'] == 'publish') : ?>
                            <form action="<?= base_url('unpublish-learningpaths/') . $learningPaths['id']; ?>" method="POST" class="flex">
                          ...
                          <?php else : ?>
                            <form action="<?= base_url('publish-learningpaths/') . $learningPaths['id']; ?>" method="POST" class="flex">
                          ...
                          <?php endif; ?>
                          <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-800 dark:text-white dark:hover:bg-neutral-800" data-hs-overlay="#hs-publish-learning-path">
                            Batal
                          </button>
                        </div>
                      </div>
                ...
                <button class=" py-2 px-6 text-sm font-semibold text-gray-800 bg-yellow-400 rounded-md shadow-sm hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-all dark:bg-yellow-500 dark:hover:bg-blue-500 dark:focus:ring-blue-500" data-hs-overlay="#hs-edit-learning-path">
                  Edit
                </button>
                ...
                <div id="hs-edit-learning-path" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
                  <div class="flex justify-center items-center hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-4xl sm:w-full m-3 h-[calc(100%-3.5rem)] sm:mx-auto">
                    ...
                    <form action="<?= base_url('update-learningpaths/' . $learningPaths['id']); ?>" method="POST" enctype="multipart/form-data">
                      <?= csrf_field(); ?>
                              ...
                              <div class="grid gap-4 md:grid lg:gap-6 lg:grid-cols-5">
                                <div class="col-span-3 space-y-4">
                                  ...
                                  <div>
                                    ...
                                    <input type="text" value=" <?= $learningPaths['name'] ?>" name="nama_learning_path" id="nama_learning_path" placeholder="Inputkan nama learning path" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" />
                                  </div>
                                  ...
                                  <div>
                                    ...
                                    <textarea id="keterangan_learning_path" placeholder="Inputkan keterangan learning path" name="keterangan_learning_path" rows="4" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"><?= $learningPaths['description'] ?></textarea>
                                  </div>
                                  <!-- End Keterangan -->
                                ...
                                <div class="col-span-2">
                                  ...
                                  <!-- old thumbnail -->
                                  <input type="hidden" name="old_learning_path_thumbnail" value="<?= $learningPaths['thumbnail'] ?>">
                ...
                <button class="py-2 px-4 text-sm font-semibold text-gray-800 bg-red-400 rounded-md shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all dark:bg-red-500 dark:hover:bg-red-500 dark:focus:ring-red-500" data-hs-overlay="#delete_learning_path">
                  Hapus
                </button>
        ...
        <div class="p-1.5 min-w-full inline-block align-middle">
          <div class="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
            ...
            <div class="px-6 py-4 grid gap-3 bg-gray-50 lg:flex md:justify-between lg:items-center border-b border-gray-200 dark:border-neutral-700">
              ...
              <div class="space-x-2">
                <button class="py-2 px-3 text-sm font-semibold text-gray-800 bg-green-400 rounded-md shadow-sm hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all dark:bg-green-500 dark:hover:bg-blue-500 dark:focus:ring-blue-500">
                  Simpan
                </button>
                <button class="py-2 px-3 text-sm font-semibold text-gray-800 bg-blue-400 rounded-md shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all dark:bg-blue-500 dark:hover:bg-blue-500 dark:focus:ring-blue-500" data-hs-overlay="#modal_tambah_course">
                  Tambah Course
                </button>

                <!-- Modal Tambah Course -->
                <div id="modal_tambah_course" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
                  <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-4xl sm:w-full m-3 h-[calc(100%-3.5rem)] sm:mx-auto">
                    <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-900 dark:border-neutral-800 dark:shadow-neutral-700/70">
                      <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-800">
                        ...
                        <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-transparent dark:hover:bg-neutral-700" data-hs-overlay="#modal_tambah_course">
                          <span class="sr-only">Close</span>
                          <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M18 6 6 18" />
                            <path d="m6 6 12 12" />
                              ...
                              <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                  ...
                                  <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                      <div class="flex items-center gap-x-3">
                                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Microsoft Word</span>
                                      </div>
                                    </div>
                                  </td>
                                  <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                      <div class="flex items-center gap-x-3">
                                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Soft Skill</span>
                                      </div>
                                    </div>
                                  </td>
                                  <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                      <div class="flex items-center gap-x-3">
                                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Mandatory</span>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                                <tr class="hover:bg-blue-100">
                                  ...
                                  <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                      <div class="flex items-center gap-x-3">
                                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Hard Skill</span>
                                      </div>
                                    </div>
                                  </td>
                                  <td class="size-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                      <div class="flex items-center gap-x-3">
                                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Opsional</span>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                      ...
                      <div class="flex justify-end items-center gap-x-2 p-4 sm:px-7 border-t dark:border-neutral-800">
                        <a type="button" class="cursor-pointer py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-800 dark:text-white dark:hover:bg-neutral-800" data-hs-overlay="#modal_tambah_course">
                          Cancel
                        </a>
                        <button type="submit" class="py-2 px-5 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                          Tambah
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
              ...
              <tbody id="sortable" class="divide-y divide-gray-200 dark:divide-neutral-700">
                <tr class="hover:bg-gray-100 cursor-move">
                  <td class="size-px whitespace-nowrap">
                    <div class="px-6 py-3">
                      <span id="sequence" class="text-sm text-gray-600 dark:text-neutral-400">1</span>
                    </div>
                  </td>
                  <td class="size-px whitespace-nowrap">
                    <div class="px-6 py-3">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">Microsoft Office</span>
                    </div>
                  </td>
                  <td class="size-px whitespace-nowrap">
                    <div class="px-6 py-1.5 text-end">
                      <div class="hs-dropdown [--placement:bottom-right] relative inline-block">
                        <a href="" type="button" class="block" data-hs-overlay="#hs-ai-invoice-modal">
                ...
                <tr class="hover:bg-gray-100 cursor-move">
                  <td class="size-px whitespace-nowrap">
                    <div class="px-6 py-3">
                      <span id="sequence" class="text-sm text-gray-600 dark:text-neutral-400">2</span>
                    </div>
                  </td>
                  <td class="size-px whitespace-nowrap">
                    <div class="px-6 py-3">
