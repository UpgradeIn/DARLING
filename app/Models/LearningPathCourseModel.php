...
class LearningPathCourseModel extends Model
{
    ...
    public function getLearningPathCoursesForUserPage($learning_path_id)
    {
        ...
        $builder->select('tb_learning_path_courses.sequence, tb_courses.thumbnail as course_thumbnail, tb_courses.name as course_name, tb_courses.slug as course_slug,');
